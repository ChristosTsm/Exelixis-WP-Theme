    <div class="ex-mr ex-ml">
        ...
        <h1><i><?php _e('Οι Υπηρεσίες μας', 'exelixis-circus'); ?></i></h1>
        ...
        <div class="row align-items-end justify-content-center services-wrapper">
            ...
            <div class="col-lg-4 col-md-12 ex-services-item" data-aos="fade-up-right">
                ...
                <div data-aos="fade-up-right" data-aos-delay="250">
                    ...
                    <h3 class="services-link"><a href="<?php echo esc_url( get_page_link( 57 ) ); ?>"><?php _e('Ασφαλεια<br>αυτοκινητου', 'exelixis-circus'); ?></a></h3>
            ...
            <div class="col-lg-4 col-md-12 ex-services-item" data-aos="fade-up-left" data-aos-delay="650">
                ...
                <div data-aos="fade-up-left" data-aos-delay="850">
